...
class ReadingSession {
    ...
    async init() {
        ...
        try {
            ...
            if (Array.isArray(data.pages)) {
                ...
                // split into pages roughly by paragraph
    ...
    renderCurrentPage() {
        ...
        this.expectedWords = pageText.toLowerCase().split(/\s+/);
        ...
        document.getElementById('pageNumber').textContent = `${this.currentIndex + 1} / ${this.pages.length}`;
    }
    ...
    async finish() {
        ...
        const totalWords = this.wordsRead + (this.pages[this.currentIndex] ? this.pages[this.currentIndex].split(/\s+/).length : 0);
